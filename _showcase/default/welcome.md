...
<div class="p-2 pb-2">
    ...
    <p>
        <strong>Early Psychosis Detection using EEG-Derived Features</strong><br>
        <em>CSE496 - Introduction to Biomedical Engineering</em><br>
        Supervisor: Dr. Tanzilur Rahman
    </p>
    <p>
        <strong>Multi-label Classification of Bengali Hate Comments on Social Media</strong><br>
        <em>CSE465 - Pattern Recognition and Neural Network Project</em><br>
